...
Monitor.prototype.restart = function () {
  ...
  return this.kill('TERM');
};

Monitor.prototype.gracefulrestart = function () {
  this.forceRestart = true;
  return this.kill('USR2');
};
...
Monitor.prototype.usr2 = function () {
  return this.kill('USR2');
}

Monitor.prototype.kill9 = function () {
  return this.kill('KILL');
}
...
//
Monitor.prototype.kill = function (signal) {
  var self = this,
      child = this.child;
  ...
  if (!child || !this.running) {
    ...
    common.kill(this.child.pid, this.killTree, signal, function () {
